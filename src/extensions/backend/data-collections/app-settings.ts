...
export default {
  ...
  fields: [
    ...
    { type: 'TEXT', displayName: 'Fournisseur de paiement actif', key: 'paymentProvider' },
    { type: 'TEXT', displayName: 'PayFlow - fournisseur préparé', key: 'payflowProvider' },
    { type: 'TEXT', displayName: 'PayFlow - environnement', key: 'payflowEnvironment' },
    { type: 'TEXT', displayName: 'PayFlow - compte fournisseur ID', key: 'payflowAccountId' },
    { type: 'TEXT', displayName: 'PayFlow - statut du compte', key: 'payflowAccountStatus' },
    { type: 'BOOLEAN', displayName: 'PayFlow - informations soumises', key: 'payflowDetailsSubmitted' },
    { type: 'BOOLEAN', displayName: 'PayFlow - paiements activés', key: 'payflowChargesEnabled' },
    { type: 'BOOLEAN', displayName: 'PayFlow - versements activés', key: 'payflowPayoutsEnabled' },
    { type: 'TEXT', displayName: 'PayFlow - exigences actuelles (JSON)', key: 'payflowRequirementsCurrentlyDueJson' },
    { type: 'TEXT', displayName: 'PayFlow - exigences en retard (JSON)', key: 'payflowRequirementsPastDueJson' },
    { type: 'TEXT', displayName: 'PayFlow - vérifications en attente (JSON)', key: 'payflowRequirementsPendingVerificationJson' },
    { type: 'TEXT', displayName: 'PayFlow - pays', key: 'payflowCountry' },
    { type: 'TEXT', displayName: 'PayFlow - devise par défaut', key: 'payflowDefaultCurrency' },
    { type: 'DATETIME', displayName: 'PayFlow - dernière synchronisation', key: 'payflowLastSyncedAt' },
